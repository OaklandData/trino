...
public class TestAudienceTable
{
    private final AudienceTable barbTable = new AudienceTable("tableName",
            ImmutableList.of(new AudienceColumn("a", createUnboundedVarcharType()), new AudienceColumn("b", BIGINT)),
    ...
    public void testRoundTrip()
    {
        ...
        AudienceTable barbTableCopy = TABLE_CODEC.fromJson(json);
