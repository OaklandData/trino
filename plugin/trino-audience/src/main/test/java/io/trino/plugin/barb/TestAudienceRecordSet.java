...
public class TestAudienceRecordSet
{
    private AudienceHttpServer barbHttpServer;
    private String dataUri;

    @Test
    public void testGetColumnTypes()
    {
        RecordSet recordSet = new AudienceRecordSet(new AudienceSplit(dataUri), ImmutableList.of(
                new AudienceColumnHandle("text", createUnboundedVarcharType(), 0),
                new AudienceColumnHandle("value", BIGINT, 1)));
        assertEquals(recordSet.getColumnTypes(), ImmutableList.of(createUnboundedVarcharType(), BIGINT));

        recordSet = new AudienceRecordSet(new AudienceSplit(dataUri), ImmutableList.of(
                new AudienceColumnHandle("value", BIGINT, 1),
                new AudienceColumnHandle("text", createUnboundedVarcharType(), 0)));
    ...
    public void setUp()
    {
        barbHttpServer = new AudienceHttpServer();
