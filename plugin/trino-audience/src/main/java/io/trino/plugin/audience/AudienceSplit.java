...
{
    private static final int INSTANCE_SIZE = toIntExact(ClassLayout.parseClass(AudienceSplit.class).instanceSize());
    ...
    @JsonCreator
    public AudienceSplit(@JsonProperty("uri") String uri)
    {
